...
public class App {
    ...
    //The conn object represents the database connection, singleton pattern
    public static Connection conn;
    public static Integer user_id=-1;
    public static Integer id=-1;//job-provider/job-seeker id
    public static User logginUser;///polymorphsm using method overriding, SINGELTON PATTERN
    ...
    public static void main(String[] args) throws IOException, SQLException, NoSuchAlgorithmException, ParseException {
        ...
        try {
            ...
            //The database connection (conn) is created at the start and then passed and used in other parts of the program.
    ...
    private static void log_out() throws NoSuchAlgorithmException, IOException, SQLException, ParseException {
        ...
        //Command Pattern edhe tek login_view(), signup_view()
        //
        open_view();
    }

    public static boolean checkLogin(){
        //loggin user is singelton pattern ,used in static methods to interact with the user data
    ...
    public static void update_password_view() throws IOException, NoSuchAlgorithmException, SQLException, ParseException{
        ...
        if(new_password.equals(confirm_password)){
            if(logginUser.validatePassword(App.hashPassword(current))){
                //Dependency Injection (DI) Pattern
                //new password (App.hashPassword(new_password)) is created 
                // then passed and used in other parts of the program
        ...
        //Strategy Pattern,if(logginUser.getUserType().equals(UserType.JOB_SEEKER)) seeker_profile_view(); else provider_profile_view();
    ...
    //Factory Pattern ,employment_list_view()
    ...
    //new Project() in project_list_view() is Factory Pattern
    ...
    //factory pattern in new edu() in education_update_view()
    ...
    //factory pattern in new education() in employment_update_view()
    ...
    //Factory Pattern new SimpleDateFormat("dd-mm-yyyy") line in the project_update_view()
    //if(!title.isEmpty()) in project_update_view() startegy pattern
